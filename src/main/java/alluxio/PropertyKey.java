...
public enum PropertyKey {
  ...
  SITE_CONF_DIR(Name.SITE_CONF_DIR,
      "${user.home}/.alluxio/,/etc/alluxio/,${ALLUXIO_HOME}/conf,"
          + "/software/servers/alluxio-1.4.1/conf"),
  TEST_MODE(Name.TEST_MODE, false),
  VERSION(Name.VERSION, "1.5.0-release"),
  ...
  MASTER_STARTUP_LAZY_CONSISTENCY_CHECK_ENABLED(
  ...
  MASTER_WORKER_CONNECTION_TIMEOUT_MS(Name.MASTER_WORKER_CONNECTION_TIMEOUT_MS, 0),

  // JD
  MASTER_CLUSTERNAME(Name.MASTER_CLUSTERNAME, ""),
  MASTER_ETCD(Name.MASTER_ETCD, ""),
  MASTER_WORKER_COUNT(Name.MASTER_WORKER_COUNT, -1),
  MASTER_PROXY_ENABLE(Name.MASTER_PROXY_ENABLE, false),
  MASTER_PROXY_HOST(Name.MASTER_PROXY_HOST, "172.22.91.78"),
  MASTER_PROXY_PORT(Name.MASTER_PROXY_PORT, 80),
  WORKER_BLOCK_LOCK_WARN_REPORTER_ENABLED(Name.WORKER_BLOCK_LOCK_WARN_REPORTER_ENABLED, true),
  WORKER_BLOCK_LOCK_WARN_REPORTER_TIMEOUT(Name.WORKER_BLOCK_LOCK_WARN_REPORTER_TIMEOUT, 600000),
  ...
  public static final class Name {
    ...
    // JD
    public static final String MASTER_CLUSTERNAME = "alluxio.master.clustername";
    public static final String MASTER_ETCD = "alluxio.master.etcd";
    public static final String MASTER_WORKER_COUNT = "alluxio.master.worker.count";
    public static final String MASTER_PROXY_ENABLE = "alluxio.proxy.enable";
    public static final String MASTER_PROXY_HOST = "alluxio.proxy.host";
    public static final String MASTER_PROXY_PORT = "alluxio.proxy.port";
    public static final String WORKER_BLOCK_LOCK_WARN_REPORTER_ENABLED =
        "alluxio.worker.block.lock.warn.reporter.enabled";
    public static final String WORKER_BLOCK_LOCK_WARN_REPORTER_TIMEOUT =
        "alluxio.worker.block.lock.warn.reporter.timeout";
    //
    // Worker related properties
    //
    ...
    public static final String MASTER_WORKER_CONNECTION_TIMEOUT_MS =
        "alluxio.worker.master.connection.timeout.ms";
  ...
  private static Map<String, PropertyKey> initKeysMap() {
    Map<String, PropertyKey> map = new HashMap<String, PropertyKey>();
